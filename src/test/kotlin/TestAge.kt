...
class CodewarsLeaderboardClimberTest {
    ...
    fun basicTests() {
        ...
        assertEquals("Winning!", CodewarsLeaderboardClimber.leaderBoard("user400", 15991, 17000))
        assertEquals("Only need one!", CodewarsLeaderboardClimber.leaderBoard("user444", 15991, 15991))
    }
}